...
find.newTFs <- function()
{
  ...
  tbl.prospects <- subset(tbl.gwas, CHR=="chr11" & (BP > tss-10) & (BP < tss+800))
  gene <- "NDUFAF6"
...
{
    motifs <- c("ZNF148.p2","MA0163.1","MA0810.1","MA0599.1","MA0524.2","MA0811.1","MA0524.2","MA0039.2",
                "sci09.v2_Plagl1_0972",
                "MA0136.2", "MA0598.2")
                #"MA0146.2")
